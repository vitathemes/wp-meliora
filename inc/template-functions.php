 ...
 * @return array
 */
if ( ! function_exists( 'wp_meliora_body_classes' ) ) {
 ...
 */
if ( ! function_exists( 'wp_meliora_pingback_header' ) ) {
...
if ( ! function_exists( 'wp_meliora_branding' ) ) {
...
if ( ! function_exists( 'wp_meliora_typography' ) ) {
...
if ( ! function_exists( 'wp_meliora_theme_settings' ) ) {
